...
<body>
	<div class="page-container">
		<form name="SearchState" method="post"
			Action="enterpage?ActionType=enterpage_Select4">
			<div class="text-c">
		...
		<div class="mt-20">
			...
			<ec:table items="USERLIST" var="row"
			    action="enterpage?ActionType=enterpage_Select8"
			    view="html" 
			     >
			   <ec:row>
        		...
        		<ec:column property="wish1s" style="text-align:center;" escapeAutoFormat="true" sortable="false" title="一志愿录取人数" />
        		<ec:column property="rate" style="text-align:center;" title="一志愿录取率"/>
				</ec:row>
			</ec:table>
		</div>
	</div>
