...
<script>
	...
	<div class="x-nav">
			<span class="layui-breadcrumb">
				...
				<a href="javacipt:void(0)">2018年志愿率详情</a>
				<a><cite>历年志愿率详情</cite></a>
			</span>
...
<%--	<div id="current">当前位置：志愿详情&gt; 历年志愿详情</div>--%>
	<div class="page-container">
	<form style="float: left;"
			name="SearchState" method="post"
			Action="mainpage?ActionType=mainpage_Select2&FLAG=select">
			<div style="color: white">
				...
				<select class="select" name="major" id="major">
						...
						<c:forEach items="${MAJORLIST}" var="major">
							<option value="${major.ZYDH }">${major.ZYMC }</option>
						</c:forEach> --%>
				</select>
				</span>
		...
		<h1 style="padding-left: 40%;color: white;">历年志愿详情表</h1>
		<div class="mt-20">
			<!--数据列表-START-->
			...
			<ec:table items="USERLIST" var="row"
			   ...
			   <ec:row>
				...
				<ec:column property="EDIT" style="text-align:center;" title="操作" viewsDenied="xls">
        			<a href="#" onClick="formPost(window.SearchState,'','mainpage?ActionType=mainpage_Select2Major&YEAR=<c:out value='${row.YEAR1 }'/>&MAJOR=<c:out value='${row.ZYDH }'/>',this);">详情</a> 
        		</ec:column>
				</ec:row>
			</ec:table>
		</div>
