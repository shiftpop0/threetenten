...
<body style="background: #333">
	<div class="x-nav">
			<span class="layui-breadcrumb">
				...
				<a href="javacipt:void(0)">2018年调剂率详情</a>
				<a><cite>历年调剂率详情</cite></a>
			</span>
...
<%--		<div id="current">当前位置：调剂率详情&gt; 历年调剂率详情</div>--%>
	<div class="page-container">
	<form style="float: left;"
			name="SearchState" method="post"
			Action="mainpage?ActionType=mainpage_Select3&FLAG=select">
	...
	<h1 style="padding-left: 40%;color: white;">历年调剂率详情表</h1>
	<div class="mt-20">
			...
			<ec:table items="USERLIST" var="row"
			    action="mainpage?ActionType=mainpage_Select3"
			    view="html" 
			     >
			   <ec:row>
			    <ec:column style="text-align:center;" width="7%" property="rowcount" cell="rowCount" title="序号" sortable="false"/>
        		<ec:column property="ZYDH" style="text-align:center;" title="专业代号" />
        		<ec:column property="ZYMC" style="text-align:center;" title="专业" />
        		<ec:column property="KLMC" style="text-align:center;" title="专业类别"/>
        		<ec:column property="TiaoJisum" style="text-align:center;" title="调剂人数" />
        		<ec:column property="TiaoJi_Rate" style="text-align:center;" title="调剂率"/>
				...
				<ec:column property="EDIT" style="text-align:center;" title="操作" viewsDenied="xls">
        			<a href="#" onClick="formPost(window.SearchState,'','mainpage?ActionType=mainpage_Select3Family&YEAR=<c:out value='${row.YEAR1 }'/>&MAJOR=<c:out value='${row.ZYDH }'/>',this);">详情</a> 
        		</ec:column>
				</ec:row>
			</ec:table>
	</div>
