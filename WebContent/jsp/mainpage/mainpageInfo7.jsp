...
<%--		<div id="current">当前位置：调剂率详情 &gt; 2018年调剂率详情</div>--%>
	<div class="page-container">
		<form style="float: left"
				name="SearchState" method="post"
			Action="mainpage?ActionType=mainpage_Select7&FLAG=select">
		...
		<h1 style="padding-left: 40%;color: white;">2018年调剂率详情表</h1>
		<div class="mt-20">
			...
			<ec:table items="USERLIST" var="row"
			    action="mainpage?ActionType=mainpage_Select7"
			    view="html" 
			     >
			   <ec:row>
        		...
        		<ec:column property="LQsum" style="text-align:center;" title="录取人数" />
