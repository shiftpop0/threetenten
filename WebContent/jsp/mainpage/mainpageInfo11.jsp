...
<body>
<div id="current">当前位置：专业热度详情&gt; ${YEAR }年${USERLIST[0].ZYMC }专业热度详情</div>
	<div class="page-container">
		<form name="SearchState" method="post"
			Action="mainpage?ActionType=mainpage_Select4Major&YEAR=<c:out value='${YEAR }'/>&MAJOR=<c:out value='${MAJOR }'/>">
			<div class="text-c">
	    ...
	    <h1 style="text-align:center;">${YEAR }年${USERLIST[0].ZYMC }专业热度详情</h1>
		<div class="mt-20">
			...
			<ec:table items="USERLIST" var="row"
			   ...
			   <ec:row>
				...
				<ec:column property="EDIT" style="text-align:center;" title="操作" viewsDenied="xls">
        			<a href="#" onClick="formPost(window.SearchState,'','mainpage?ActionType=mainpage_SelectAll&YEAR=<c:out value='${row.YEAR1 }'/>&ZYDH=<c:out value='${row.LQZY }'/>&FAMILY=<c:out value='${row.DQDM }'/>&Flag=RD',this);">详情</a> 
        		</ec:column>
				</ec:row>
			</ec:table>
		</div>
