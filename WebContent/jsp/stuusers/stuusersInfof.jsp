...
$(function() {
    ...
    $("#btnsearch").click(
        function() {
            formPost(window.SearchState, '','stuusers?ActionType=stuusers_Select', this);
    });
});
</script>
<body>
<div class="page-container">
    ...
    <form name="SearchState" method="post" Action="stuusers?ActionType=stuusers_SelectByFamily">
	<div class="text-c"> 
		...
		省份:
		<span class="select-box inline">
			<select class="select" name = "family">
