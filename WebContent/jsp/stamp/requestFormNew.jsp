...
<body>
	<div id="current">当前位置：用印管理 &gt; 用印申请 &gt; 新建申请单</div>

    <form id="NewRequestForm" name="NewRequestForm" method="post">
            ...
            <tr>
                <td height="30" align="center" class="xxpage">
                	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="14%" class="xxpage_td2">项目名称：</td>
